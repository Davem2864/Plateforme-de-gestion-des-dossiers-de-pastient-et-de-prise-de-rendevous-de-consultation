            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <div class="d-sm-flex align-items-center justify-content-between mb-4">
                        <h1 class="h3 mb-0 text-gray-800">Messageries</h1>
                                ...
                                $today = date('Y-m-d');
                                echo $today;
                                $messagerow= $database->query("select  * from  message_pt;");
                                ?>
                                </p>
                    </div>
                    <!-- Content Row -->
                        ...
                        <div class="col-xl-12 col-lg-12" width="100%">
                            <div class="card shadow mb-12" width="100%" style="    display: flex;
                                ...
                                <div class="card-header py-3 d-flex flex-row align-items-center justify-content-between" style="width: 100%;">
                                    <h6 class="m-0 font-weight-bold text-primary">Messages/Patients (<?php echo $messagerow->num_rows ?>), Note: ceci est une messagerie du centre mediacl, veillez vous identifier dans la conversation...</h6>
                                </div>
                                <div class="card-body" style="padding: 0; height: calc(100% - 56px);">
                                    <div id="chat-container" class="my-custom-container">
                                        <div id="messages" class="my-custom-messages"></div>
                                        <form id="messageForm" class="my-custom-message-input">
                                            <input type="hidden" id="pid" value="<?php echo $userid ?>"> <!-- Exemple de Patient ID -->
                                            <div class="d-flex align-items-center w-100">
                                                <textarea id="messageText" class="my-custom-message-text" placeholder="Enter your message"></textarea>
                                                <button type="button" id="sendButton" class="btn btn-primary ms-2" style="margin-left: 10px; width:50px; align-items: self-end;">
