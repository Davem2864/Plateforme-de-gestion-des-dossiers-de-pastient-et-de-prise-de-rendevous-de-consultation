                               ...
                               if($result->num_rows==0){
                                ...
                                for ($x = 0; $x < ($result->num_rows); $x++) {
                                    for ($q = 0; $q < 3; $q++) {
                                        ...
                                        echo '
                                        <div style="flex: 0 0 calc(33.33% - 20px); margin: 10px; box-shadow: 0 4px 8px 0 rgba(0,0,0,0.2); transition: 0.3s; border-radius: 5px; padding: 20px; box-sizing: border-box; color: #000;">
                                            <div id="' . $uniqueId . '">
                                                <div style="width:100%;">
                                                    <div class="h3-search">
                                                    <strong> Date de Reservation: </strong>' . substr($appodate, 0, 30) . '<br>
                                                    <strong>Numero de Reference: </strong>OC-000-' . $appoid . '
                                                    </div>
                                                    <div class="h1-search">
                                                    <strong>TITRE DE LA SESSION : </strong><strong> ' . $title . '</strong><br>
                                                    </div>
                                                    <div class="h3-search">
                                                    <strong>  Numero de Rendez-vous:</strong><div class="h1-search">0' . $apponum . '</div>
                                                    </div>
                                                    <div class="h3-search">
                                                    <strong>DOCTEUR : </strong><strong>' . substr($docname, 0, 30) . '</strong>
                                                    </div>
                                                    <div class="h4-search">
                                                    <strong>  Date de la Session:</strong> ' . $scheduledate . '<br><strong>Debut</strong>: <b>@' . substr($scheduletime, 0, 5) . '</b> (24h)
                                                    </div>
                                                </div>
                                            </div>
                                            <br>
                                            <a href="#" onclick="confirmCancellation(' . $appoid . ', \'' . $title . '\', \'' . $docname . '\')">
                                                <button class="btn btn-danger" style="padding-top:11px;padding-bottom:11px;width: 100%;margin: 5px;">
                                                    <i class="fas fa-times"></i> <font class="tn-in-text">Cancel Booking</font>
                                                </button>
                                            </a>
                                            <br>
