                                ...
                                <table class="table table-bordered" id="dataTable1" width="100%" cellspacing="0">
                                        ...
                                        for ( $x=0; $x<$result->num_rows;$x++){
                                            ...
                                            <td>
                                                <div style="display:flex;justify-content: center;">
                                                    ...
                                                    <a href="#" class="non-style-link" style="margin-left:10px;" onclick="confirmDeletion('.$docid.', \''.$name.'\')">
                                    ...
                                    $(document).ready(function() {
                                        ...
                                        function confirmDeletion(docid, name) {
                                            Swal.fire({
                                                title: 'Êtes-vous sûr ?',
                                                text: `Vous voulez voir les sessions et voir si le docteur (${name}) y a une session ?`,
                                                icon: 'info',
