...
--
-- Hôte : 127.0.0.1:3306
-- Généré le : ven. 02 août 2024 à 19:37
...
INSERT INTO `admin` (`aemail`, `apassword`, `profile`, `statut`) VALUES
('admin@edoc.com', '$2y$10$29aHpSF4Nc76e9A86KBI3.AIr4FtNSmyYjPpx90V8lpytlgWHKSrq', '../img/dave.jpg', 'actif');
...
(71, 11, 10, 15, '2024-07-30'),
(72, 7, 11, 15, '2024-07-31');

--
-- Déclencheurs `appointment`
--
DROP TRIGGER IF EXISTS `update_dossier_date_maj_after_appointment_insert`;
DELIMITER $$
CREATE TRIGGER `update_dossier_date_maj_after_appointment_insert` AFTER INSERT ON `appointment` FOR EACH ROW BEGIN
    UPDATE dossier
    SET date_maj = CURRENT_TIMESTAMP
    WHERE pid = NEW.pid;
END
$$
DELIMITER ;
...
INSERT INTO `archive` (`id`, `email`, `user_type`, `deleted_at`) VALUES
(1, 'david.kablenge0022@gmail.com', 'p', '2024-07-29 23:54:34'),
(2, 'doctor@edoc.com', 'd', '2024-07-30 22:24:01'),
(3, 'doctor@edoc.com', 'd', '2024-07-30 22:28:44');
...
CREATE TABLE IF NOT EXISTS `doctor` (
  ...
  `profile` varchar(255) DEFAULT '../img/profile.jpeg',
...
INSERT INTO `doctor` (`docid`, `docemail`, `docname`, `docpassword`, `docnic`, `doctel`, `specialties`, `profile`, `statut`) VALUES
(1, 'doctor@edoc.com', 'Test Doctor', '$2y$10$MJ1EueqFbbzWK55zvcP2ku6qq5fTiIwox8djeeJFBMuSoby.G.JCO', '000000000', '0110000000', 1, '../img/profile.jpeg', 'inactif'),
(2, 'docdan.edoc2864@gmail.com', 'Docteur Dan', '$2y$10$MJ1EueqFbbzWK55zvcP2ku6qq5fTiIwox8djeeJFBMuSoby.G.JCO', '25610', '0971450634', 5, '../img/Capture d’écran 2022-11-22 202534.jpg', 'actif'),
(27, 'joel@edoc.com', 'Upasula Joel', '$2y$10$MJ1EueqFbbzWK55zvcP2ku6qq5fTiIwox8djeeJFBMuSoby.G.JCO', '25610', '0990901269', 19, '../img/profile.jpeg', 'actif'),
(4, 'soni@edoc.com', 'Soni Mpakanyi', '$2y$10$MJ1EueqFbbzWK55zvcP2ku6qq5fTiIwox8djeeJFBMuSoby.G.JCO', '25610', '0971450634', 37, '../img/profile.jpeg', 'actif'),
(5, 'abraham@edoc.com', 'Kitali Abraham', '$2y$10$MJ1EueqFbbzWK55zvcP2ku6qq5fTiIwox8djeeJFBMuSoby.G.JCO', '25610', '0971450634', 13, '../img/profile.jpeg', 'actif'),
(6, 'ben@edoc.com', 'Benediction Lukeka', '$2y$10$MJ1EueqFbbzWK55zvcP2ku6qq5fTiIwox8djeeJFBMuSoby.G.JCO', '25610', '0998775773', 10, '../img/profile.jpeg', 'actif'),
(7, 'dorcas@edoc.com', 'Dorcas Mbonyibuga', '$2y$10$MJ1EueqFbbzWK55zvcP2ku6qq5fTiIwox8djeeJFBMuSoby.G.JCO', '25610', '0977253323', 14, '../img/profile.jpeg', 'actif'),
(30, 'achille@edoc.com', 'Achille Mbuluku', '$2y$10$MJ1EueqFbbzWK55zvcP2ku6qq5fTiIwox8djeeJFBMuSoby.G.JCO', '25610', '0991787976', 30, '../img/profile.jpeg', 'actif'),
(29, 'laurence@edoc.com', 'Laurence Masika', '$2y$10$MJ1EueqFbbzWK55zvcP2ku6qq5fTiIwox8djeeJFBMuSoby.G.JCO', '25610', '0990901269', 32, '../img/profile.jpeg', 'actif'),
(28, 'jean@edoc.com', 'Jean Mirimba', '$2y$10$MJ1EueqFbbzWK55zvcP2ku6qq5fTiIwox8djeeJFBMuSoby.G.JCO', '25610', '0990901269', 1, '../img/profile.jpeg', 'actif'),
(26, 'gisela@edoc.com', 'Gisella Mbuluku', '$2y$10$MJ1EueqFbbzWK55zvcP2ku6qq5fTiIwox8djeeJFBMuSoby.G.JCO', '25610', '0990901269', 7, '../img/profile.jpeg', 'actif'),
(25, 'luc@edoc.com', 'Luc Masifa', '$2y$10$MJ1EueqFbbzWK55zvcP2ku6qq5fTiIwox8djeeJFBMuSoby.G.JCO', '25610', '0837253323', 6, '../img/profile.jpeg', 'actif'),
(24, 'archange@edoc.com', 'Archange Madua', '$2y$10$MJ1EueqFbbzWK55zvcP2ku6qq5fTiIwox8djeeJFBMuSoby.G.JCO', '25611', '0837253323', 1, '../img/profile.jpeg', 'actif');
...
(4, 7, '2024-05-05', '2024-07-31'),
(5, 8, '2024-05-14', '2024-05-14'),
(6, 9, '2024-07-01', '2024-07-01'),
(7, 10, '2024-07-30', '2024-07-30'),
(8, 11, '2024-07-30', '2024-07-30');
...
CREATE TABLE IF NOT EXISTS `patient` (
  ...
  `profile` varchar(255) CHARACTER SET latin1 COLLATE latin1_swedish_ci NOT NULL,
  `statut` enum('actif','inactif') DEFAULT 'actif',
  PRIMARY KEY (`pid`)
...
INSERT INTO `patient` (`pid`, `pemail`, `pname`, `ppassword`, `paddress`, `pnic`, `pdob`, `ptel`, `profile`, `statut`) VALUES
(1, 'patient@edoc.com', 'Test Patient', '$2y$10$r9kq7eZ5.TNEvaHgdZbsh.FHEZ9tfECxviSZPptDwNHhOsxE0j/Ba', 'Sri Lanka', '0000000000', '2000-01-01', '0120000000', '../img/profile.jpeg', 'actif'),
(2, 'emhashenudara@gmail.com', 'Hashen Udara', '$2y$10$r9kq7eZ5.TNEvaHgdZbsh.FHEZ9tfECxviSZPptDwNHhOsxE0j/Ba', 'Sri Lanka', '0110000000', '2022-06-03', '0700000000', '../img/profile.jpeg', 'actif'),
(3, 'mbuluku2864@gmail.com', 'David Mbuluku', '$2y$10$r9kq7eZ5.TNEvaHgdZbsh.FHEZ9tfECxviSZPptDwNHhOsxE0j/Ba', 'Goma', '25610', '1998-07-03', '0971244063', '../img/profile.jpeg', 'actif'),
(4, 'mbuluku2864@gmail.com', 'David Mbuluku', '$2y$10$r9kq7eZ5.TNEvaHgdZbsh.FHEZ9tfECxviSZPptDwNHhOsxE0j/Ba', 'Goma', '25610', '1998-07-03', '0971244063', '../img/profile.jpeg', 'actif'),
(5, 'alowambembo@gmail.com', 'Daniel Mbembo', '$2y$10$r9kq7eZ5.TNEvaHgdZbsh.FHEZ9tfECxviSZPptDwNHhOsxE0j/Ba', 'Goma', '25610', '1999-11-11', '0971244063', '../img/profile.jpeg', 'actif'),
(6, 'davidmbk22@gmail.com', 'David Mbuluku', '$2y$10$r9kq7eZ5.TNEvaHgdZbsh.FHEZ9tfECxviSZPptDwNHhOsxE0j/Ba', 'Goma', '25610', '1998-07-03', '0971244063', '../img/profile.jpeg', 'actif'),
(7, 'tegemeo.org2864@gmail.com', 'Gisella Mbuluku', '$2y$10$KQoj5xfK6CAlHCKbM9mRJuoJs7sHzvCoG0dzmkTupGb9VcnnyskUy', 'goma', '25610', '1990-05-25', '0871244063', '../img/giso.jpg', 'actif'),
(8, 'da01@gmail.com', 'David Mbuluku', '$2y$10$r9kq7eZ5.TNEvaHgdZbsh.FHEZ9tfECxviSZPptDwNHhOsxE0j/Ba', 'goma', '25610', '2024-05-14', '0971450634', '../img/profile.jpeg', 'actif'),
(9, 'kalalamushiya5@gmail.com', 'Kalala Genyl', '$2y$10$r9kq7eZ5.TNEvaHgdZbsh.FHEZ9tfECxviSZPptDwNHhOsxE0j/Ba', 'Goma', '25610', '2003-01-01', '0974329701', '../img/genyl.png', 'actif'),
(10, 'david.kablenge0022@gmail.com', 'David Kabulenge', '$2y$10$r9kq7eZ5.TNEvaHgdZbsh.FHEZ9tfECxviSZPptDwNHhOsxE0j/Ba', 'Goma, 01 avenue du golf', 'goma', '0000-00-00', '0971244063', '../img/profile.jpeg', 'inactif'),
(11, 'david.kabulenge0022@gmail.com', 'David Kabulenge', '$2y$10$r9kq7eZ5.TNEvaHgdZbsh.FHEZ9tfECxviSZPptDwNHhOsxE0j/Ba', 'Goma, 01 avenue du golf', 'goma', '0000-00-00', '0971244063', '../img/dave.jpg', 'actif');
...
(9, 6, 2, 10, 30, '2024-07-28', '2024-07-31', '$today = date(\'Y-m-d\');'),
(10, 7, 2, 6, 31, '2024-07-29', '2024-08-29', 'test inf'),
(11, 11, 2, 8, 32, '2024-07-30', '2024-08-13', 'kxce kewjfojefnnweihnsdkjhiusdkjsdisdfksdvdjdvkh');

--
-- Déclencheurs `prescription`
--
DROP TRIGGER IF EXISTS `update_dossier_date_maj_after_prescription_insert`;
DELIMITER $$
CREATE TRIGGER `update_dossier_date_maj_after_prescription_insert` AFTER INSERT ON `prescription` FOR EACH ROW BEGIN
    UPDATE dossier
    SET date_maj = CURRENT_TIMESTAMP
    WHERE pid = NEW.pid;
END
...
--
-- Structure de la table `rapportdoc`
--

DROP TABLE IF EXISTS `rapportdoc`;
CREATE TABLE IF NOT EXISTS `rapportdoc` (
...
--
-- Déchargement des données de la table `rapportdoc`
--

INSERT INTO `rapportdoc` (`rapport_id`, `docid`, `report_date`, `total_patients`, `common_diagnoses`, `common_treatments`, `common_prescriptions`, `general_notes`) VALUES
(1, 0, '0000-00-00', 0, '', '', '', ''),
(3, 0, '2024-07-29', 0, '', '', '', ''),
(4, 2, '2024-07-29', 20, 'test 1\r<br>• test 1\r<br>• test 1\r<br>• test 1\r<br>• test 1\r<br>• \r<br>• ', '30', '9', 'test 1\r\ntest 1\r\ntest 1\r\ntest 1\r\ntest 1'),
(5, 2, '2024-07-29', 10, 'test 1\r<br>• test 2\r<br>• test 3\r<br>• test 4\r<br>• test 4', '28,29,30', '7,8,9', 'test 1\r\ntest 2\r\ntest 3\r\ntest 4\r\ntest 4');
...
INSERT INTO `traitement` (`tid`, `pid`, `docid`, `nom`, `description`, `dosage`, `frequence`, `date_dbt`, `date_fin`, `etat`, `effet_sec`, `date_trait`) VALUES
(1, 1, 1, 'test', 'test', 'test', 'once-weekly', '2024-05-02', '2024-05-31', 'test', 'test', '0000-00-00'),
(2, 1, 1, 'test2', 'test2', 'test2', 'every-other-day', '2024-05-02', '2024-06-02', 'test2', 'test2', '0000-00-00'),
(3, 1, 1, 'test3', 'test3', 'test3', 'twice-daily', '2024-05-02', '2024-06-02', 'test3', 'test3', '0000-00-00'),
(4, 7, 2, 'Traitement Cardiaque', 'Ce traitement vise a amélioré l\'état du patient , réguler sa fréquence cardiaque et amélioré la fluidité de la circulation sanguine', '20', 'three-times-daily', '2024-05-05', '2024-06-05', 'le patient se plain d\'une forte douleur au ventre, à la poitrine, des nausées et il a signalé une présence de vomissement', 'au début de ce traitement le patient sentira une légère douleur au bas de la colonne vertébrale et une augmentation de la nausée ', '0000-00-00'),
(5, 7, 2, 'traitement antipaludique', 'TEST', '20', 'three-times-daily', '2024-05-07', '2024-05-14', 'TEST', 'TEST', '0000-00-00'),
(6, 7, 2, 'Traitement Cardiaque', 'test', '20', 'once-weekly', '2024-05-15', '2024-06-15', 'test', 'test', '0000-00-00'),
(7, 6, 0, 'Traitement Cardiaque', 'test', '20', 'three-times-daily', '2024-06-01', '2024-06-08', 'test', 'test', '0000-00-00'),
(8, 6, 0, 'Traitement Cardiaque', 'test', '20', 'three-times-daily', '2024-06-01', '2024-06-15', 'tets', 'test', '0000-00-00'),
(9, 6, 2, '', 'test', '20', 'three-times-daily', '2024-06-01', '2024-06-15', 'test', 'test', '0000-00-00'),
(10, 6, 2, 'Predinisolone', 'test', '20', 'three-times-daily', '2024-06-01', '2024-06-15', 'test', 'test', '0000-00-00'),
(11, 6, 2, 'Predinisolone', 'test', '20', 'three-times-daily', '2024-06-01', '2024-06-15', 'test', 'test', '0000-00-00'),
(12, 6, 2, 'Predinisolone', 'test', '20', 'three-times-daily', '2024-06-01', '2024-06-15', 'test', 'test', '0000-00-00'),
(13, 6, 2, '', '', '', 'once-daily', '0000-00-00', '0000-00-00', '', '', '0000-00-00'),
(14, 6, 2, '', '', '', 'once-daily', '0000-00-00', '0000-00-00', '', '', '0000-00-00'),
(15, 6, 2, '', '', '', 'once-daily', '0000-00-00', '0000-00-00', '', '', '0000-00-00'),
(16, 6, 2, 'fb', 'fb', '20', 'once-weekly', '2024-07-04', '2024-07-07', ' dzvfr', '2drw', '0000-00-00'),
(17, 6, 2, 'fb', 'fb', '20', 'once-weekly', '2024-07-04', '2024-07-07', ' dzvfr', '2drw', '0000-00-00'),
(18, 6, 2, 'fb', 'fb', '20', 'once-weekly', '2024-07-04', '2024-07-07', ' dzvfr', '2drw', '0000-00-00'),
(19, 6, 2, 'fb', 'fb', '20', 'once-weekly', '2024-07-04', '2024-07-07', ' dzvfr', '2drw', '0000-00-00'),
(20, 6, 2, 'fb', 'fb', '20', 'once-weekly', '2024-07-04', '2024-07-07', ' dzvfr', '2drw', '0000-00-00'),
(21, 6, 2, 'fb', 'fb', '20', 'once-weekly', '2024-07-04', '2024-07-07', ' dzvfr', '2drw', '0000-00-00'),
(22, 6, 2, 'fb', 'fb', '20', 'once-weekly', '2024-07-04', '2024-07-07', ' dzvfr', '2drw', '0000-00-00'),
(23, 6, 2, 'thbd', 'dnj', '20', 'every-other-day', '2024-06-01', '2024-06-29', 'dth', 'dtmj', '0000-00-00'),
(24, 6, 2, 'Predinisolone', 'test', '20', 'once-daily', '2024-06-01', '2024-07-01', 'test', 'test', '0000-00-00'),
(25, 6, 2, 'Predinisolone', 'test', '20', 'once-daily', '2024-06-01', '2024-07-01', 'test', 'test', '0000-00-00'),
(26, 6, 2, 'test', 'test', '2', 'once-daily', '2024-06-01', '2024-07-06', 'test', 'test', '0000-00-00'),
(27, 6, 2, 'Predinisolone', 'test', '20', 'twice-daily', '2024-06-01', '2024-06-08', 'test', 'test', '0000-00-00'),
(28, 6, 2, 'fb', 'test', '20', 'once-daily', '2024-06-01', '2024-06-08', 'test', 'test', '0000-00-00'),
(29, 7, 2, 'Traitement visant a remédier a une lombalgie', 'dans le tout début de ce traitement le patient va remarquer une perte de poids et un manque d\'appétit léger, il pourra probablement se plaindre d\'une nausée et des vertiges', '500', 'twice-daily', '2024-06-09', '2024-06-23', 'le patient ici présent se plaint de problème au niveau du ventre, présence de pestilences pas net et qui sentent les œufs pourris. pour ce faire je juge bon de procéder a une évaluation plus approfondie', 'la jaunisse se présente dans un premier cas mais rien de grave le patient prenant se traitement devra le signaler lors de son prochain rendez-vous', '0000-00-00'),
(30, 6, 2, '$today = date(\'Y-m-d\');', '$today = date(\'Y-m-d\');', '20', 'four-times-daily', '2024-07-28', '2024-07-31', 'test 22', '$today = date(\'Y-m-d\');', '0000-00-00'),
(31, 7, 2, 'zx,nm.vcaSJGC bnxzm', 'dvbzfd', '20', 'three-times-daily', '2024-07-29', '2024-08-29', 'o;ugfbvcs;DIZvh zxcbs;udc', 'AEBRSF VCDGdbcxFSGDbcxFSgdhfxng', '2024-07-29'),
(32, 11, 2, 'traitement visant a fluidifier le paroie de l\'uterus', 'cet sdhbdvdsbkxcvkxxchusdih;sdhsdhsdhsdksdnjkdsh', '20', 'four-times-daily', '2024-07-30', '2024-08-06', 'le patient jlhsdgcinvchxjKBKJXKNCVJKxcvbsIDSBVBCXJKBVMNXBNM BXM,BHJSXBMXBMBSLKDJBKJSMNSD HSDBKNSDABISDKSDBKJSDBMDSBJKDBVSDBBKH', 'luyasdghjasdgkhjsvdfnsdgkygbsdfbsidlfb', '2024-07-30');

--
-- Déclencheurs `traitement`
--
DROP TRIGGER IF EXISTS `update_dossier_date_maj_after_traitement_insert`;
DELIMITER $$
CREATE TRIGGER `update_dossier_date_maj_after_traitement_insert` AFTER INSERT ON `traitement` FOR EACH ROW BEGIN
    UPDATE dossier
    SET date_maj = CURRENT_TIMESTAMP
    WHERE pid = NEW.pid;
END
...
('david.kabulenge0022@gmail.com', 'p');
COMMIT;
