                        ...
                        <div class="p-5">
                            <div class="text-center">
                                <h1 class="h4 text-gray-900 mb-4">Let's Get Started</h1>
                                    <h1 class="h4 text-gray-900 mb-4">Add Your Personal Details to Continue</h1>
                            </div>
                            <form class="user" action="" method="POST">
                                ...
                                <div class="form-group row">
                                    <div class="col-sm-6 mb-3 mb-sm-0">
                                        <input type="text" name="nic" class="form-control form-control-user"
                                            id="nic" placeholder="Your nic number">
                                    </div>
                                    <div class="col-sm-6">
                                        <input type="date" name="dob" class="form-control form-control-user"
                                            id="dob" placeholder="Repeat Password">
                                    </div>
                                </div>
                                <input type="submit" value="Next" class="btn btn-primary btn-user btn-block">
                                <input type="reset" value="Reset" class="btn btn-primary btn-user btn-block">
                                <hr>
