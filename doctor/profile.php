                        ...
                        <div class="card-body d-flex flex-column">
                                    ...
                                    <div class="tab-pane fade show active" id="viewProfile" role="tabpanel" aria-labelledby="view-tab">
                                        <div class="card mt-3">
                                            <div class="card-body d-flex flex-column align-items-center">
                                                ...
                                                <h5 class="card-title mt-3" id="doctorName"></h5>
                                                <p class="card-text" id="doctorEmail"></p>
                                                <p class="card-text" id="doctorNic"></p>
                                                <p class="card-text" id="doctorTel"></p>
                                                <p class="card-text" id="doctorSpecialties"></p>
                                            </div>
                                        </div>
                                    </div>
                                    <!-- Edit Profile Tab -->
                                        ...
                                        <div class="card mt-3">
                                            ...
                                            <form id="editProfileForm">
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <select class="form-control" id="editSpecialties" multiple>
                            ...
                            <script>
                                document.addEventListener('DOMContentLoaded', function() {
                                    var doctorId = <?php echo $userid;?>; // Replace with actual doctor ID from session or context
                                    ...
                                    fetch(`get_doctor_profile.php?id=${doctorId}`)
                                        ...
                                        .then(data => {
                                            if (data.success) {
                                                ...
                                                document.getElementById('profileImg').src = doctor.profile;
                                                document.getElementById('doctorName').innerText = doctor.docname;
                                                document.getElementById('doctorEmail').innerText = `Email: ${doctor.docemail}`;
                                                document.getElementById('doctorNic').innerText = `NIC: ${doctor.docnic}`;
                                                document.getElementById('doctorTel').innerText = `Telephone: ${doctor.doctel}`;
                                                document.getElementById('doctorSpecialties').innerText = `Specialties: ${doctor.specialties}`;

                                                // Fill the edit form
                                                document.getElementById('editName').value = doctor.docname;
                                                document.getElementById('editEmail').value = doctor.docemail;
                                                document.getElementById('editNic').value = doctor.docnic;
                                                document.getElementById('editTel').value = doctor.doctel;
                                                document.getElementById('editSpecialties').value = doctor.specialties;

                                                // Populate specialties dropdown
                                                fetch('get_specialties.php')
                                                    .then(response => response.json())
                                                    .then(data => {
                                                        if (data.success) {
                                                            var specialties = data.specialties;
                                                            var specialtiesSelect = document.getElementById('editSpecialties');
                                                            specialtiesSelect.innerHTML = '';
                                                            specialties.forEach(specialty => {
                                                                var option = document.createElement('option');
                                                                option.value = specialty.id;
                                                                option.text = specialty.sname;
                                                                if (specialty.sname === doctor.specialties) {
                                    ...
                                    document.getElementById('editProfileForm').addEventListener('submit', function(event) {
                                        ...
                                        var specialties = Array.from(document.getElementById('editSpecialties').selectedOptions).map(option => option.value);
                                        formData.append('specialties', specialties.join(',')); // Send as comma-separated string
